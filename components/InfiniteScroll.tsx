...
const InfiniteScroll = ({ isManual, hasNextPage, isFetchingNextPage, fetchNextPage }: InfiniteScrollProps) => {
    ...
    return (
        <div className="flex flex-col items-center gap-4 p-4">
            ...
            {hasNextPage ? (
                ...
                <p className="text-xs text-muted-foreground capitalize">you have reached the end of the page</p>
            )}
        </div>
    );
};
