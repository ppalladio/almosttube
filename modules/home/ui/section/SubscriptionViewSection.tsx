...
const SubscriptionViewSection = () => {
    return (
        <Suspense fallback={<VideosSectionSkeleton />}>
		<ErrorBoundary fallback={<div>Something went wrong</div>}>
                <SubscriptionViewSectionSuspense />
            </ErrorBoundary>
        </Suspense>
    );
};
...
const SubscriptionViewSectionSuspense = () => {
    const [videos, query] = trpc.videos.getSubscriptions.useSuspenseInfiniteQuery(
        { limit: 5 },
        {
...
export default SubscriptionViewSection;
